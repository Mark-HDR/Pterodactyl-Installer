...
cd pterodactyl
sudo curl -Lo panel.tar.gz https://github.com/pterodactyl/panel/releases/download/v1.11.10/panel.tar.gz
...
echo "user: admin"
echo "pass: Admin1234"
echo "Please change user password before continuing."
echo "Note default user and password, press enter when you're ready to continue install."
